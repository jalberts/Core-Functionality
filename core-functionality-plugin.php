...
// Metabox Class & Declarations
include_once( JRA_DIR . '/lib/functions/metaboxes.php' );
include_once( JRA_DIR . '/lib/metabox/custom-meta-boxes.php' );
...
// To Do: Process this on registration of CPT, to avoid re-activating plugin.
